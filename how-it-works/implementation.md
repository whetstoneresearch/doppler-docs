...
1. Applications send a message to the Doppler smart contracts to create a token. This message can be formed entirely utilizing the [doppler-sdk](../resources/legacy-sdks-and-migration-guides/v3/factory.md)
