---
description: A high level overview of where Doppler is planning to go...
icon: map-location
---
...
{% hint style="info" %}
If you have questions, feedback, or there are other things you would like to see in the Roadmap, please reach out to [contact@whetstone.cc](mailto:contact@whetstone.cc), a team member directly, or join the [Doppler Telegram](https://doppler.lol/telegram).
{% endhint %}
